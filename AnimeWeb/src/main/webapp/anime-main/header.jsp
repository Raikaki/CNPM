        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="header__logo">
                    <a href="/anime-main/Index"> <img src="img/logo.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-7">
                ...
                <div class="header__right2">
                    <c:choose>
                        ...
                        <c:when test="${empty sessionScope.user}">
                            <%-- 1. Người dùng chọn vào thẻ login để bắt đầu chức năng đăng nhập--%>
            ...
            <div class="col-lg-12">
                ...
                <div class="header__nav">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="active"><a href="/anime-main/Index"><fmt:message>menu.hompage</fmt:message></a>
                            </li>
