...
<%--  import trang header cho trang index  --%>
                                        ...
                                        <div class="product__item">
                                            ...
                                            <div class="product__item__pic set-bg"
                                                    ...
                                                    <c:if test="${!movie.isFree()}">
                                                        <a href="${MovieDetail}?idMovie=${movie.id}">
                                                            <div class="price_film">
                                                                <div class="text_price">${movie.getRenderPrice()}đ</div>
                                                            </div>
                                                        </a>
                                                    </c:if>
                                                </c:if>
                                                <c:if test="${user !=null }">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${ purchasedIds.contains(movie.id)}">
                                                        </c:when>
                                                        <c:when test="${!movie.isFree()&& !purchasedIds.contains(movie.id)}">
                                                            <a href="${MovieDetail}?idMovie=${movie.id}">
                                                                <div class="price_film">
                                                                    <div class="text_price">${movie.getRenderPrice()}đ</div>
                                                                </div>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end mb-0">
                            ...
                            <c:forEach var="i" begin="1" end="${requestScope.totalMovie}">
                                ...
                                <a class="page-link"
                                   href="${Index}?&&index=${i-1}&&filter=${requestScope.param}">${i}</a>
                                </li>
                            </c:forEach>
